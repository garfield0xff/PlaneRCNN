                        ...
                        const char* fmt, ...)
{
    ...
    switch (level)
    {
        case LOG_LEVEL_FATAL:       color = RED;        levelName = "FATAL";    break;
        case LOG_LEVEL_ERROR:       color = RED;        levelName = "ERROR";    break;
        case LOG_LEVEL_WARNING:     color = BLUE;       levelName = "WARN";     break;
        case LOG_LEVEL_INFO:        color = GREEN;      levelName = "INFO";     break;
        case LOG_LEVEL_DEBUG:       color = COLOFF;     levelName = "DEBUG";    break;
        case LOG_LEVEL_VERBOSE:     color = COLOFF;     levelName = "VERB";     break;
        default: break;
    }
